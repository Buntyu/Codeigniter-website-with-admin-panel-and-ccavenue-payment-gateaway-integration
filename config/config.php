...
define("COMPANYNAME","BISJ Exporters");
...
define("DBNAME",DBPREFIX.'bisjez6o_codeigniter'); // Here the database name is 'dummy_myecommerce'

// Add your database user name here
define("DBUSER",DBPREFIX.'bisjez6o_admin');  // Here the username is 'dummy_website'

// Add your database password here
define("DBPWD",'X_ofGB(FtTwz'); 
...
|
*/
$config['subclass_prefix'] = 'bisjez6o_';

...
//$comm = $orderData["order_amount"]*10;
$comm1 = $orderData["order_amount"]/100*10;
$comm2 = $comm1/100*10;
$tdscomm = $comm1-$comm2;
...
<form id = "final_order_update" action = "<?php echo base_url()."admin/sales/updatefinalOrder" ?>" method="POST" >
...
<input type="hidden" class="or_status" name = "or_status" value="" />
...
<table class="table table-bordered">
	<tbody>
	    <tr>
			...
			<td colspan>
				<input type = "text" name="ccavenue_date" value = "<?php echo $ccDate; ?>"/> <br>
    ...
    <span class = 'btn btn-large btn-danger' onclick = "cancelOrder()" >Cancel Order</span>
	<span class = 'btn btn-large btn-success updbtn' onclick = "submitOrder()" >Update Order</span>
	<br /><br /><br />
